      ...
      >
        <div>
          ...
          <div className="carousel-img-content">
            ...
            <p>₹{img1 ? img1.price : ""}</p>
            <Link className="buybtn" to={`/${img1 ? img1.slug : ""}/${img1 ? img1._id : ""}/p`}>
              Buy Now
            </Link>
          </div>
        ...
        <div>
          ...
          <div className="carousel-img-content">
            ...
            <p>₹{img2 ? img2.price : ""}</p>
            <Link className="buybtn" to={`/${img2 ? img2.slug : ""}/${img2 ? img2._id : ""}/p`}>
              Buy Now
            </Link>
          </div>
        </div>
        <div>
          ...
          <div className="carousel-img-content">
            ...
            <p>₹{img3 ? img3.price : ""}</p>
            <Link className="buybtn" to={`/${img3 ? img3.slug : ""}/${img3 ? img3._id : ""}/p`}>
              Buy Now
            </Link>
          </div>
        </div>
        <div>
          ...
          <div className="carousel-img-content">
            ...
            <p>₹{img4 ? img4.price : ""}</p>
            <Link className="buybtn" to={`/${img4 ? img4.slug : ""}/${img4 ? img4._id : ""}/p`}>
              Buy Now
            </Link>
          </div>
        </div>
        <div>
          ...
          <div className="carousel-img-content">
            ...
            <p>₹{img5 ? img5.price : ""}</p>
            <Link className="buybtn" to={`/${img5 ? img5.slug : ""}/${img5 ? img5._id : ""}/p`}>
              Buy Now
            </Link>
          </div>
        </div>
        <div>
          ...
          <div className="carousel-img-content">
            ...
            <p>₹{img6 ? img6.price : ""}</p>
            <Link className="buybtn" to={`/${img6 ? img6.slug : ""}/${img6 ? img6._id : ""}/p`}>
              Buy Now
            </Link>
          </div>
        </div>
        <div>
          ...
          <div className="carousel-img-content">
            ...
            <p>₹{img7 ? img7.price : ""}</p>
            <Link className="buybtn" to={`/${img7 ? img7.slug : ""}/${img7 ? img7._id : ""}/p`}>
              Buy Now
            </Link>
          </div>
        </div>
        <div>
          ...
          <div className="carousel-img-content">
            ...
            <p>₹{img8 ? img8.price : ""}</p>
            <Link className="buybtn" to={`/${img8 ? img8.slug : ""}/${img8 ? img8._id : ""}/p`}>
              Buy Now
            </Link>
          </div>
        </div>
        <div>
          ...
          <div className="carousel-img-content">
            ...
            <p>₹{img9 ? img9.price : ""}</p>
            <Link className="buybtn" to={`/${img9 ? img9.slug : ""}/${img9 ? img9._id : ""}/p`}>
              Buy Now
            </Link>
          </div>
        </div>
