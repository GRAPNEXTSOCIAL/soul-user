...
const HomePage = (props) => {
  ...
  return (
    <>
      <Carousel variant="dark" style={{ marginTop: "-50px" }}>
        <Carousel.Item>
          <img
...
<section class="about_area">
  <div class="container container-xxl w-100 place-congtent-center">
    <div class="row">
...
<br />
 ...
 <div className="headding-all">
<h2>Fevourite <span style={{"color" : "#660066"}}>Saree</span></h2>
<br/><br/>
<Slider1 />
</div>
<br/><br/>
...
<div className="headding-all">
  <h2>
    All <span style={{ color: "#660066" }}>Products</span>
  </h2>
  <br/>
  <br/>
<Slider />
...
<div className="headding-all">
<h2>Fevourite <span style={{"color" : "#660066"}}>Kurti</span></h2>
<br/><br/>
<Slider2 />
</div>
<br/><br/>
